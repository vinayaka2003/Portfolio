    ...
    <section className="border-b border-gray-100 dark:border-border">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-32 md:py-40">
        ...
        <motion.h1
          ...
          className="text-5xl sm:text-6xl md:text-8xl font-medium tracking-tight leading-[0.95] mb-8 max-w-5xl"
        >
          Hi, I’m Vinayaka S
        </motion.h1>
        ...
        >
          <a
            ...
            className="flex-1 sm:flex-none text-center px-4 sm:px-6 py-3 bg-black dark:bg-accent text-white dark:text-black rounded-xl text-xs sm:text-sm font-medium hover:opacity-90 transition whitespace-nowrap"
          >
            View Resume
          </a>
          <a
            href="/resume.pdf"
            download
            className="flex-1 sm:flex-none text-center px-4 sm:px-6 py-3 border border-gray-200 dark:border-border rounded-xl text-xs sm:text-sm text-gray-600 dark:text-muted hover:bg-gray-50 dark:hover:bg-surface-hover transition whitespace-nowrap"
          >
            Download Resume
          </a>
        </motion.div>
