...
export default function Contact() {
  return (
    <div className="py-8 sm:py-12 font-serif antialiased space-y-10 sm:space-y-12">
      
      {/* Header/Intro */}
      <section className="space-y-4">
        <h1 className="text-[34px] sm:text-[44px] font-bold tracking-tight text-foreground font-serif leading-tight">
          Contact
        </h1>
      ...
      {/* Direct Contact List */}
      <section className="space-y-4 text-[17px] sm:text-[18px] leading-[1.65] text-muted font-serif border-t border-border/60 pt-6">
        <div className="grid grid-cols-1 sm:grid-cols-[120px_1fr] gap-1 sm:gap-4 pb-3 border-b border-border/60">
          ...
          <a href="mailto:vinayakayattinamane@gmail.com" className="text-muted hover:text-accent underline decoration-muted/40 hover:decoration-accent underline-offset-4 transition-colors">
            vinayakayattinamane@gmail.com
          </a>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-[120px_1fr] gap-1 sm:gap-4 pb-3 border-b border-border/60">
          <span className="font-bold text-foreground font-serif">GitHub</span>
          <a href="https://github.com/vinayaka2003" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-accent underline decoration-muted/40 hover:decoration-accent underline-offset-4 transition-colors">
            github.com/vinayaka2003
          </a>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-[120px_1fr] gap-1 sm:gap-4 pb-3 border-b border-border/60">
          <span className="font-bold text-foreground font-serif">LinkedIn</span>
          <a href="https://linkedin.com/in/vinayaka2003" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-accent underline decoration-muted/40 hover:decoration-accent underline-offset-4 transition-colors">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[120px_1fr] gap-1 sm:gap-4">
          ...
          <a href="https://twitter.com/vinayaka_s_y" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-accent underline decoration-muted/40 hover:decoration-accent underline-offset-4 transition-colors">
            @vinayaka_s_y
          </a>
        </div>
      </section>
